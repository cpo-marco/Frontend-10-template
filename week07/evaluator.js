...
export class Evaluator{
    constructor() {
        ...
        this.ecs = [new ExecutionContext(this.realm,
            new ObjectEnviromentRecord(this.globalObject),
            new ObjectEnviromentRecord(this.globalObject))];
    }

    evaluateModule(node) {
        let globalEC = this.ecs[0];
        this.newEC = new ExecutionContext(this.realm,
            new EnviromentRecord(globalEC.lexicalEnviroment),
            new EnviromentRecord(globalEC.lexicalEnviroment));
        this.ecs.push(newEC);
    ...
    VariableDeclaration(node) {
        ...
        runningEC.lexicalEnviroment.add(node.children[1].name);
    ...
    Block(node) {
        ...
        let newEC = new ExecutionContext(
            runningEC.realm,
            new EnviromentRecord(runningEC.lexicalEnviroment),
    ...
    FunctionDeclaration(node) {
        ...
        func.call = args =>{
            let newEC = new ExecutionContext(
                this.realm,
                new EnviromentRecord(func.enviroment),
                new EnviromentRecord(func.enviroment));  
            this.ecs.push(newEC);  
            this.evaluate(code);
            this.ecs.pop();
        ...
        let runningEC = this.ecs[this.ecs.length -1];
        runningEC.lexicalEnviroment.add(name);
        runningEC.lexicalEnviroment.set(name, func);
        func.enviroment = runningEC.lexicalEnviroment;
        return new CompletionRecord("normal");
    }
